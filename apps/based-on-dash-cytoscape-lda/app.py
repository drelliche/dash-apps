    ...
    [
        dbc.Row(
            [
                ...
                ##### What is this?
                -----
                I (Elizabeth) took this demo code from the Dash Sample apps
        ...
        dbc.Row(
            [
                dcc.Markdown(
                    """
            -----
            ##### Put some information here about how to navigate this network

            Maybe we want color or size or something to convey information, or not?

            Can we filter modules by topic category? Programming language? Are they modules with no prereqs?
            * Let's get Julie's support in how to filter
            * when someone clicks on a modules link, it should show the data about that module below (or we could put that somewhere else)
            * Whether we wrote the module or it is an external module we have packaged?
